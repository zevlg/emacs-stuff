...
(defface egg-header
    '((t (:bold t :inherit variable-pitch :height 1.1)))
...
(defsubst egg-git-dir (&optional error-if-not-git)
  ...
  (if (local-variable-p 'egg-git-dir (current-buffer))
      egg-git-dir
...
(defconst egg-staged-diff-section-map 
  (let ((map (make-sparse-keymap "Egg:StagedDiff")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-status-popup-staged-diff-menu)
    (define-key map (kbd "C-<button2up>") 'egg-status-popup-staged-diff-menu)
...
(defconst egg-unstaged-diff-section-map 
  (let ((map (make-sparse-keymap "Egg:UnstagedDiff")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-status-popup-unstaged-diff-menu)
    (define-key map (kbd "C-<button2up>") 'egg-status-popup-unstaged-diff-menu)
...
(defconst egg-staged-hunk-section-map 
  (let ((map (make-sparse-keymap "Egg:StagedHunk")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-status-popup-staged-hunk-menu)
    (define-key map (kbd "C-<button2up>") 'egg-status-popup-staged-hunk-menu)
...
(defconst egg-unstaged-hunk-section-map 
  (let ((map (make-sparse-keymap "Egg:UnstagedHunk")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-status-popup-unstaged-hunk-menu)
    (define-key map (kbd "C-<button2up>") 'egg-status-popup-unstaged-hunk-menu)
...
(unless (fboundp 'force-window-update)
  (defalias 'force-window-update 'ignore-errors))
...
(defun egg-commit-log-edit (title-function
  ...
  (let* ((git-dir (egg-git-dir))
    ...
    (with-current-buffer buf
      ...
      (insert "\n")
      (insert (egg-prop "------------------------ End of Commit Message ------------------------" 
...
(defconst egg-log-commit-map 
  (let ((map (make-sparse-keymap "Egg:LogCommit")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-log-popup-commit-line-menu)
    (define-key map (kbd "C-<button2up>") 'egg-log-popup-commit-line-menu)
...
(defconst egg-log-local-ref-map 
  (let ((map (make-sparse-keymap "Egg:LogLocalRef")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-log-popup-local-ref-menu)
    (define-key map (kbd "C-<button2up>") 'egg-log-popup-local-ref-menu)
...
(defconst egg-log-remote-ref-map 
  (let ((map (make-sparse-keymap "Egg:LogRemoteRef")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-log-popup-remote-ref-menu)
    (define-key map (kbd "C-<button2up>") 'egg-log-popup-remote-ref-menu)
...
(defconst egg-log-remote-site-map 
  (let ((map (make-sparse-keymap "Egg:LogRef")))
    ...
    (define-key map (kbd "C-<button2down>") 'egg-log-popup-remote-site-menu)
    (define-key map (kbd "C-<button2up>") 'egg-log-popup-remote-site-menu)
...
(defun egg-generic-display-logs (data &optional init)
  ...
  (let ((title (or (plist-get data :title) "NO TITLE"))
